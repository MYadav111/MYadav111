  ...
  const showAddress = () => {
    return (
      <div>
        ...
        <div>
          {userData[0].building},{userData[0].towerno},{userData[0].floorNo}
        </div>
      ...
      return (
        <div>
          <div style={{ display: "flex", alignItems: "center" }}>
            <div
              style={{
                marginLeft: matches ? 40 : 20,
                width: matches ? "45%" : "52%",
              }}
            >
              <img
                src={`${serverURL}/images/${item.picture}`}
                style={{ width: matches ? "25%" : "60%", cursor: "pointer" }}
              />
            </div>
            ...
            >
              ...
              <div style={{ marginLeft: matches ? 400 : 10, marginBottom: 15 }}>
                <PlusMinusButton
                  qty={
                    keys.includes(item?.productdetailid + "") ? item?.qty : 0
                  }
