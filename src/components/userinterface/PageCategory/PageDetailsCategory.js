...
import smartbazaar from "./smartbazaar.png"
import copyicon from "./copyicon.png"

export default function PageDetailsCategory({ product, setProduct }) {
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column" }}>
        ...
        >
          ...
          <span>
            {product.weight} {product.weighttype}
          </span>
        </div>
        ...
        >
          ...
          <span style={{ marginLeft: 330, display: "flex" }}>
            ...
            <span style={{ marginLeft: 10, marginTop: 2 }}>
              <a
                href={`https://api.whatsapp.com/send?text=${serverURL}${location.pathname}`}
              >
                <ShareIcon />
              </a>{" "}
            </span>
            ...
            >
              {item.offerprice > 0 ? (
                ...
                <div>
                  ...
                  >
                    <span style={{ fontSize: 15 }}>M.R.P: &nbsp;</span>
        ...
        <div>
          <span style={{ display: "flex", marginTop: 8 }}>
            ...
            <span style={{ display: "flex", flexDirection: "column" }}>
              ...
              >
                5 accelerated reward points by SBI cards (1.25%), 10 accelerated
                reward points by SBI cards (2.50%)- - Valid On NON EMI
              </span>
              <span
                style={{
                  width: 500,
              ...
              >
                {" "}
                16 Offer/s Available{" "}
              </span>
            </span>
          </span>
        </div>
        <div
          onMouseLeave={() => setOverState("#0c5273")}
          onMouseOver={() => setOverState("#1f3d4c")}
          style={{
            cursor: "pointer",
            marginTop: 8,
            width: "60%",
      ...
      <div style={{ display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", marginTop: 20 }}>
          ...
          <span style={{ marginLeft: 350 }}>
            <CreateIcon style={{ width: 50, height: 20, color: "#1f3d4c" }} />
          </span>
        </div>
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", marginTop: 20 }}>
          ...
          >
            <img src={smartbazaar} style={{ width: 100, height: 30 }} />
          </span>
        </div>
      </div>
    );
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      <div style={{ marginBottom: 8 }}>{showDetail()}</div>
      <div
        style={{ marginBottom: 8, marginLeft: 35, width: 550, marginTop: 10 }}
      >
        <Divider />
      </div>
      <div
      ...
      <div
        style={{ marginBottom: 8, marginLeft: 35, width: 550, marginTop: 8 }}
      >
        {/* {packSize()} */}
      </div>
      <div
      ...
      <div
        style={{ marginBottom: 1, marginLeft: 35, width: 550, marginTop: 1 }}
      >
        {soldby()}
      </div>
      <div
