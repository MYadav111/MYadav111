...
export default function HomePage() {
  ...
  return (
    ...
    <Header/>
      ...
      <div style={{ width: "84%", alignSelf: "center", marginTop: 35 }}>
      ...
      <div style={{ width: "84%", alignSelf: "center", marginTop: 35 }}>
        <ProductScroll refresh={refresh} setRefresh={setRefresh}  data = {popularProducts} style={{ margin: 35 }} />
      </div>

      <div style={{ width: "82%", alignSelf: "center", marginTop: 35 ,fontWeight:"bolder", fontSize:20}}>TOP DEALS</div>

      <div style={{ width: "84%", alignSelf: "center", marginTop: 35 }}>
        <ProductScroll refresh={refresh} setRefresh={setRefresh}  data={[]} style={{ marginTop: 35 }} />
      </div>

      <div style={{ width: "84%", alignSelf: "center", marginTop:45 }}>
        <BankScroll title={"Bank Offers"} data={bankOffer} style={{ marginTop: 35 }}  />
      </div>

      {matches ? (
        <div style={{ width: "84%", alignSelf: "center", marginTop: 40 }}>
          <Footer />
        </div>
      ) : (
        <></>
