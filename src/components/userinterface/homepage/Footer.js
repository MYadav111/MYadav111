        ...
        <Box style={{ marginTop: 50 }}>
            <AppBar position="static" style={{ backgroundColor: '#f5f5f5', display: 'flex', flexDirection: 'column' }}>
                <Grid container style={{ paddingLeft: 100, paddingTop: 40, paddingBottom: 20 }}>
                    <Grid item xs={2}>
                        <div style={{ fontWeight: 800, fontSize: 16, padding: 8, color: '#141414', }}>All Categories</div>
                    ...
                    <Grid item xs={2}>
                        <div style={{ fontWeight: 800, fontSize: 16, padding: 8, color: '#141414', }}>Popular Categories</div>
                        ...
                        <div style={{ color: "#636e72", fontWeight: 500, fontSize: 16, letterSpacing: -0.08, lineHeight: 1.5, padding: 8 }}>Cookinh Essentials</div>
                        ...
                        <div style={{ color: "#636e72", fontWeight: 500, fontSize: 16, letterSpacing: -0.08, lineHeight: 1.5, padding: 8 }}>School, Office & Stationary</div>
                    </Grid>

                    <Grid item xs={2}>
                        <div style={{ fontWeight: 800, fontSize: 16, padding: 8, color: '#141414', }}>Customer Account</div>
                    ...
                    <Grid item xs={4} >
                        ...
                        <div>
                            <span><img src="/iphone.svg" style={{ width: '30%' }} /></span>
            ...
            <div style={{ backgroundColor: '#f5f5f5', display: 'flex', alignItems: 'center', maxWidth: 1398, width: '100%', paddingLeft: 8, paddingRight: 8, paddingTop: 8, paddingBottom: 8 }}>
                <div style={{ display: 'flex', alignItems: 'center', marginLeft: 100 }}>
                    <span style={{ width: 42, height: 42, borderRadius: 15, background: '#81ecec', margin: 8 }}> <img src={logo} style={{ width: 45, height: 45 }} /> </span>
                    <span style={{ fontWeight: 500, fontSize: 13, letterSpacing: -0.06, lineHeight: 1.3333333333, color: 'rgba(0, 0, 0, .65)' }}>© 2024 All rights reserved. Quickcomm Ltd.</span></div>
